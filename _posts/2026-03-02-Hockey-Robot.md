...
After recieving a number of retired components from my FRC team, I decided to build a robot for a local robot hockey league. This had a 15lbs weight limit and a 18" cube volume limit. The drive system consisted of a pair of Talon SR motor drivers and CIMs connected throuh a ~3:1 gearing to 3.25" wheels. It used a 4s LiPo to overdrive the motors and a standard RC system with PWM feeding the drivers. 
